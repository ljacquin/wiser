...
# positive value delta to the diagonal, based on the mean of the smallest strictly
# positive eigenvalues, up to a specified percentage of the total number of eigenvalues
